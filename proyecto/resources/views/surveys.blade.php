...
@section('content')
    ...
    <div class="modal fade" id="modal-validate" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content"
                style="background-color: white;background-position: center top;background-repeat: repeat;">
                ...
                <div id="contact" class="modal-body">
                    ...
                    <input class="form-control" id="from" placeholder="Remitente" type="text" tabindex="1"
                        name="name" required autofocus>
                    <label for="to">Destinatario *</label>
                    <input class="form-control" id="to" placeholder="Destinatario1;Destinatario2;Destinatario3..."
                        type="email" tabindex="2" name="name" required autofocus>
                    <label for="subject">Asunto</label>
                    <input class="form-control" id="subject" placeholder="Asunto" type="text" tabindex="3"
                        name="name" required autofocus>
                    <label for="message">Mensaje</label>
                    <textarea class="form-control" id="message" placeholder="Escriba su mensaje aquí...." tabindex="5" name="message"
                        cols="30" rows="10" required></textarea>
                    <label class="lbl">* Para varios destinatarios: escriba las direcciones de correo separados por punto
                        y coma y sin espacios.</label>

                </div>
                <div class="modal-footer">
                    <button id="btnSendMail" value="mail" class="btn-send btn btn-fill btn-info"> <span
                            class="material-icons">send</span> {{ __(' Enviar') }}</button>
    ...
    <div class="content" style="margin-top:60px;">
        <div class="col-md-6" style="margin:0 auto; margin-bottom: 50px;">
            @if ($nDays != '')
                <div class="alert alert-timeout alert-danger animacion custom-alert" style="position:relative; left:10px;"
                    role="alert">
                        ...
                        <form id="surveyResultsForm" method="POST">
                            ...
                            <div class="row mt-2 px-5">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="dropdown bootstrap-select">
                                        <select class="selectpicker" name="survey_id" id="survey_id" data-size="7"
                                            data-style="btn btn-red-icot btn-round" title=" Seleccione Encuesta"
                                            tabindex="-98">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="dropdown bootstrap-select">
                                        <select class="selectpicker" name="provincia_id" id="provincia_id"
                                            data-size="7" data-style="btn btn-red-icot btn-round"
                                            title=" Seleccione Provincia" tabindex="-98">
                                            <option value="-1">TODAS</option>
                                            @foreach ($provinces as $province)
                                                <option value="{{ $province->code }}">{{ $province->answer }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row mt-2 px-5">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="dropdown bootstrap-select">
                                        <select class="selectpicker" name="patient_id" id="patient_id" data-size="7"
                                            data-style="btn btn-red-icot btn-round" title=" Seleccione Tipo de Paciente"
                                            tabindex="-98">
                                            <option value="-1">TODOS</option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group date">
                                        <input id="endDatePicker" class='form-control' type="date"
                                            placeholder="yyyy/mm/dd" />
                                ...
                                <div class="form-group col-md-4 company_picker">
                                    ...
                                    <div class="dropdown bootstrap-select">
                                        <select class="selectpicker" name="company_id" id="company_id" data-size="7"
                                            data-style="btn btn-red-icot btn-round" title=" Seleccione Compañía"
                                            tabindex="-98">
                                            <option value="-1">TODAS</option>
                            ...
                            <div class="row mt-2 px-5">
                                <div class="col-md-12">
                                    ...
                                    <button id="btnSubmit" value="download" type="submit"
                                        class="btn btn-fill btn-success" formaction="download">
                                        <span class="material-icons">download</span> {{ __('Descargar') }}</button>
                                    <button id="btnSubmitLoad" type="submit" class="btn btn-fill btn-secondary"
                                        style="display: none">
                                    ...
                                    <button id="btnPreview" type="submit" value="preview"
                                        class="btn btn-fill btn-red-icot" formaction="preview">
                                        <span class="material-icons">visibility</span>
                                        {{ __('Previsualización') }}</button>
                                    <button id="btnPreviewLoad" type="submit" class="btn btn-fill btn-secondary"
                                        style="display: none">
                                        <span class="spinner-border spinner-border-sm" role="status"
                                            aria-hidden="true"></span>
                                        {{ __('Cargando...') }}
                                    ...
                                    <button data-toggle="modal" id="btnSendMail" data-target="#modal-validate"
                ...
                if (action == 'download') {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            ...
                            timeOutAlert($('#alertError'),
                                ' No hay datos que mostrar. Compruebe si hay datos incorrectos o faltan datos.'
                                );
                            $("#contenedor").html("");
                            $('#btnPreviewLoad').hide();
                            $('#btnPreview').show();
                        ...
                        success: function(data, textStatus, jqXHR) {
                            if (textStatus === 'success') {
                                ...
                                $.each(data, function(index, value) {
                                    $("#company_id").append('<option value="' + value
                                        .code + '">' + value.answer + '</option>');
                                });
                    ...
                    $.ajax({
                        ...
                        success: function(data, textStatus, jqXHR) {
                            if (textStatus === 'success') {
                                ...
                                $.each(data, function(index, value) {
                                    $("#centre_id").append('<option value="' + value
                                        .code + '">' + value.answer + '</option>');
                                });
